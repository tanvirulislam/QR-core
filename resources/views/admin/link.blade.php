...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> QR Code of website Link</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">QR Code of website Link</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br><br>
                                        <a href="{{route('admin.download_link',$category->id)}}" class="btn bg-olive">Download</a>
                                    </td>
                                    ...
                                    <td><button type="button" class="btn btn-danger text-light"
                                        ...
                                        <form id="delete-form-{{ $category->id }}"
                                            action="{{ route('admin.link_destroy',$category->id) }}"
