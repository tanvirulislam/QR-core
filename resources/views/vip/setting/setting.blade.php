          ...
          <div class="card-body">
            ...
            <div class="tab-content" id="custom-content-below-tabContent">
              ...
              <div class="tab-pane fade" id="custom-content-below-profile" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
                <br>
                 <form method="POST" action="{{ url('/') }}/vip/profile-update/{{ Auth::user()->id  }}" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                   {{ method_field('PUT') }} 
              ...
              <div class="tab-pane fade" id="custom-content-below-messages" role="tabpanel" aria-labelledby="custom-content-below-messages-tab"><br>
                 <form method="POST" action="{{ route('vip.password.update') }}" class="form-horizontal">
                                    @csrf
                                    @method('PUT')
                                    <div class="row clearfix">
                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
